                ...
                <section class="contact space paginas" id="pag_medicamentos">
                    <div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 col-lg-6 col-lg-offset-3">
							<h2 style="color: #1178f7;">Produtos</h2>
							<p>Nesta página você pode selecionar um produto, modificar ou cadastrar um novo. Tenha muita atenção a adição de produtos, bem como na gestão do que for estabelecido.</p>
						</div>
