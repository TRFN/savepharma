                ...
                <section class="contact space paginas" id="pag_<?=$ctx->pagina_atual();?>">
                    <div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 col-lg-6 col-lg-offset-3">
							...
							<p>Nesta página você pode modificar uma <strong>regra</strong> selecionada para o sistema de pontos. Tenha muita atenção ao alterar pois as regras refletem diretamente nos pontos dos produtos.</p>
						</div>
