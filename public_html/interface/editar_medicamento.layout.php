                ...
                <section class="contact space paginas" id="pag_<?=$ctx->pagina_atual();?>">
                    <div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 col-lg-6 col-lg-offset-3">
							<h2 style="color: #1178f7;">Modificar Medicamento</h2>
							<p>Nesta página você pode modificar um <strong>medicamento</strong> selecionado. Tenha muita atenção ao alterar pois as alterações refletem diretamente no que é visto e considerado acerca de um medicamento.</p>
						</div>
